    ...
    ReentrancyGuard
{
    ...
    /// @notice Calculates the current price per share (scaled by 1e18)
    /// @dev Returns 1e18 if there are no shares minted yet (initial price)
    /// @return price The current price per share scaled by 1e18
